...
// 用来绘图的颜色
#define COLOR_SNAKE			RGB(220,20,60)
#define COLOR_FOOD			RGB(69,139,116)
#define COLOR_BOUNDARY		RGB(139, 134, 130)
#define COLOR_TEXT			RGB(47,79,79)

// 游戏的参数的设置 
#define INIT_TIMER_ELAPSE	200	// 初始的时钟周期，确定游戏初始速度
#define	ONE_LEVELS_SCORES	1	// 每升级一次需要的计分
#define INIT_SNAKE_LEN		5	// 蛇的长度
#define SPEEDUP_RATIO		0.95 // 升级以后时间周期（确定游戏速度）提高的比例。
#define MAX_X		35	// 游戏界面大小
#define MAX_Y		35	// 游戏界面大小
